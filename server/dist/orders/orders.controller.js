...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of all orders', type: [order_dto_1.OrderResponseDto] }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Order found', type: order_dto_1.OrderResponseDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get orders by customer email' }),
    (0, swagger_1.ApiParam)({ name: 'email', description: 'Customer email' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of customer orders', type: [order_dto_1.OrderResponseDto] }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get orders by shop ID' }),
    (0, swagger_1.ApiParam)({ name: 'shopId', description: 'Shop ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of shop orders', type: [order_dto_1.OrderResponseDto] }),
    __param(0, (0, common_1.Param)('shopId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], OrdersController.prototype, "findByShop", null);
